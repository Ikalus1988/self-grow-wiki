...
覆盖 145 份 FANUC 官方手册（B-XXXXXEN/CM 系列），来源为 `rag-docs/chunks` 批次（34,100 chunks，143 PDFs 原始建库）。

## Source Provenance
- **Raw PDFs**: `rag-docs/chunks/*.json` 元数据记录了原始 PDF 路径（`/mnt/d/知识库wiki/rag-docs/chunks/`）
